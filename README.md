...
- **首页**是一张七分矩阵，七个维度横着走，这一周七天竖着走。拿到的那格填上它自己的颜色，今天套一圈橙框。底下两句是这一周现算的结论，右边挂着进成长报告的入口。有娱乐券在用的话，最上面是一条倒计时，写清到几点结束。
...
- **我的**是等级和升级进度、星尘余额、特权道具、这个月的完美日，往下依次是心愿屋、图鉴（收了多少张卡）、成长报告、家庭、头像。最下面两个入口是「想多玩一会儿」（申请加时）和「这题我不会」（说一声）。
