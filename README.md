...
登录是头像墙，点自己的头像再输四位数字。剩下的截图（任务大厅、券包、图鉴、成长报告、我的、怎么玩、登录页，以及家长端的审核、发布、我的、规则说明）在 [`screenshots/`](screenshots/) 里。
...
- **我的**分四块：身份卡；我的（我的记录、家人账号、改我的密码）；家里的事（家庭页、宝箱与券、商店与汇率、心愿与许愿池、规则说明、设置）；最下面单独一行备份与导出。设置是独立一页，分两级：先按七组列，点进去才看见这一组的项。「通知与推送」「假期日历」也收在设置里对应的那一组。版本号和项目地址在「我的」页脚。
