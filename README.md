...
- **首页**是一张七分矩阵，七个维度横着走，这一周七天竖着走。拿到的那格填上它自己的颜色，今天套一圈橙框。底下两句是这一周现算的结论，右边挂着进成长报告的入口。有娱乐券在用的话，最上面是一条倒计时，写清到几点结束。心愿那一行上面是「这题我不会」，卡住了说一声就行。二级页从哪一屏进去的就退回哪一屏。
...
- **发布**顶部三格：写任务（能选挂大厅还是派给哪个孩子，还能给任务配图）、写校准（后果怎么落地，按选的处理方式自己定档）、我发出的 N。
- **我的**里就是设置、日志和成员管理。设置是独立一页，分两级：先按七件事列组，点进去才看见这一组的项。版本号和项目地址在这一页最底下。
